...
class Application(Base):
    ...
    password_protected: Mapped[bool] = mapped_column(Boolean, default=True)
    ...
    manager_id: Mapped[str | None] = mapped_column(
        UUID(as_uuid=False), ForeignKey("managers.id"), nullable=True, index=True
    )
...
class Document(Base):
    ...
    application_id: Mapped[str] = mapped_column(
        UUID(as_uuid=False), ForeignKey("applications.id", ondelete="CASCADE"), index=True
    )
...
class Manager(Base):
    ...
    applications: Mapped[list[Application]] = relationship(backref="manager")
...
class AuditLog(Base):
    ...
    actor_manager_id: Mapped[str | None] = mapped_column(
